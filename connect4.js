...
class Game {
  constructor(Player1, Player2, width = 7, height = 6){
    ...
    this.width = width;
    this.height = height;
    // create a board with rows and collums
    this.makeHtmlBoard();
    this.makeBoard();
    // let game know if its still going or over
    this.gameOver = false;
...
// need to change the function to arrow function so it can be called by the game class
 checkForWin() {
   const _win = cells =>
